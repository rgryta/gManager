...
android {
    ...
    val gVLRealmDB: Int by rootProject.extra
    val gVNameLRealmDB: String by rootProject.extra

    compileSdk = gSdk

    defaultConfig {
        applicationId = gPackageName.plus(".lib.realmdb")
        targetSdk = gSdk
        minSdk = gMinSdk

        versionCode = gVLRealmDB
        versionName = gVNameLRealmDB
